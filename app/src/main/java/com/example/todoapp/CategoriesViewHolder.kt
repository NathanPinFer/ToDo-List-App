        ...
        when (taskCategory) {
            TaskCategory.Business -> {
                ...
                tvCategoryName.setTextColor(
                    ContextCompat.getColor(tvCategoryName.context, R.color.todo_business_category)
                )
            ...
            TaskCategory.Other -> {
                ...
                tvCategoryName.setTextColor(
                    ContextCompat.getColor(tvCategoryName.context, R.color.todo_other_category)
                )
            }
            ...
            TaskCategory.Personal -> {
                ...
                tvCategoryName.setTextColor(
                    ContextCompat.getColor(tvCategoryName.context, R.color.todo_personal_category)
                )
            }
